...
namespace ChemistryClass.Projectiles {
    public class SulfuricCloud : ModNPC {
        ...
        public override void SetDefaults() {
            ...
            npc.velocity = new Vector2(Main.rand.NextFloat(0.05f, 0.9f) * CCUtils.RandomSign, 0);
        ...
        public override void SendExtraAI(BinaryWriter writer) => writer.Write(AlphaTimerMax);
        public override void ReceiveExtraAI(BinaryReader reader) => AlphaTimerMax = reader.ReadInt32();
        ...
        public override void AI() {
            ...
            npc.frame.Y = (SpawnFrame + FrameCounter / (14 - SpawnFrame)) % 3 * 16;
            npc.frame.Height = 14;
            ...
            if (AlphaPhase == 0) if ((npc.alpha -= 3) <= 100) { AlphaPhase = 1; AlphaTimer = 0; }
            if (AlphaPhase == 1) if (AlphaTimer++ >= AlphaTimerMax) AlphaPhase = 2;
        ...
        public void SpawnDusts(int amt, bool larger) {
            ...
            Vector2 randVec = Vector2.UnitX.RotatedByRandom(CCUtils.TWO_PI);
