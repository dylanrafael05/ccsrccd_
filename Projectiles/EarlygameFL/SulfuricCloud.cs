...
namespace ChemistryClass.Projectiles.EarlygameFL {
    public class SulfuricCloud : ModNPCWithTimer {
        ...
        public override void SafeSetDefaults() {
            ...
            npc.velocity = new Vector2(Main.rand.NextFloat(0.05f, 0.9f) * Logic.RandomSign(), 0);
        ...
        public override void AI() {
            ...
            npc.frame.Y = (SpawnFrame + (int)activeTimer.Value / (14 - SpawnFrame)) % 3 * 16;
            npc.frame.Height = 14;
            ...
            if (AlphaPhase == 0) if ((npc.alpha -= 3) <= 100) { AlphaPhase = 1; timer.Set(0); }
            if (AlphaPhase == 1) if (timer.Update() >= AlphaTimerMax) AlphaPhase = 2;
        ...
        public void SpawnDusts(int amt, bool larger) {
            ...
            Vector2 randVec = Vector2.UnitX.RotatedByRandom(Mathematics.TWO_PI_FLOAT);
