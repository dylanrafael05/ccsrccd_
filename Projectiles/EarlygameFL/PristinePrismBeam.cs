...
namespace ChemistryClass.Projectiles.EarlygameFL {
    public class PristinePrismBeam : ModProjectileWithCrit {
        ...
        public static readonly double beamSpread = Mathematics.PI_FLOAT / 10;
        private double waveSpread
            => beamSpread * (1 + Mathematics.Sinusoid(1 / 6f, 2.1f));
        ...
        public void UpdateBeam() {
            ...
            if (timer > 0u && timer <= 40u) {
                curSpread = waveSpread * (1 - Math.Pow(1.000002, -Math.Pow(timer, 2)));
            }
            ...
            projectile.velocity = HostProjectile.velocity.RotatedBy(
                    ...
                    curSpread *
                    Mathematics.Sinusoid(cycleTime: rotTime, phaseShift: MotionOffset / 7f)
