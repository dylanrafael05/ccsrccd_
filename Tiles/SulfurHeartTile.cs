...
namespace ChemistryClass.Tiles {
    public class SulfurHeartTile : ModTile {
        ...
        public override void SetDefaults() {
            ...
            TileObjectData.newTile.AnchorValidTiles = new int[] { ChemistryClassWorld.SulfurOreType };
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            ...
            Item.NewItem(i * 16, j * 16, 32, 32, ModContent.ItemType<Items.Accessories.SulfurHeart>());
        ...
        private static readonly RandChance sulfurChance = new RandChance(0.01f);
            ...
            for (int curI = realI - sulfurXRange / 2; curI < realI + sulfurXRange / 2; curI += sulfurSkip) {
                for (int curJ = realJ - sulfurYRange / 2; curJ < realJ + sulfurYRange / 2; curJ += sulfurSkip) {
                    ...
                    if (sulfurChance.Evaluate() && curTile.type == ChemistryClassWorld.SulfurOreType) {
                        ...
                        NPC.NewNPC(curI * 16 + 8, curJ * 16 + 8, ModContent.NPCType<Projectiles.SulfuricCloud>());
